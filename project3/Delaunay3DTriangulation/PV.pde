...
// ===== render
color  red = color( 250, 0, 0 ); color dred = color(150, 0, 0);
color  magenta = color( 250, 0, 250 ); color dmagenta = color(150, 0, 150);
color  blue = color( 0, 0, 250 ); color dblue = color(0, 0, 150);
color  cyan = color( 0, 250, 250 ); color dcyan = color( 0, 150, 150 );
color  green = color( 0, 250, 0 ); color dgreen = color(0, 150, 0);
